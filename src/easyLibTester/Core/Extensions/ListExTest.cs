...
sealed class ListExTest : UnitTest
{
    ...
    void TestIndexOf()
    {
        ...
        list = [.. SampleFactory.CreateInts().Take(SampleFactory.NextByte + 1)];
    ...
    void TestPut()
    {
        ...
        List<int> list = [.. SampleFactory.CreateInts().Take(SampleFactory.NextByte)];
        ...
        int[] items = [.. SampleFactory.CreateInts().Take(SampleFactory.NextByte)];
